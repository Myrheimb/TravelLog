#Creates a variable where your .xls or .xlsx file is located.
#Change the path inside the '' to point to your own Excel workbook.
excelWorkBook = '2018.xlsx'

#Creates variables containing the addresses you normally drive to and from.
...
#Creates variables containing names of work places.
wpWork1 = 'Location 1'
wpWork2 = 'Location 2'
wpWork3 = 'Location 3'
wpWork4 = 'Location 4'
...
#Creates variables containing distances between locations.
